...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_DOWNSAMPLING:
  ...
  case LayerParameter_LayerType_FOLDING:
    return new FoldingLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_LOCAL_WEIGHTED_CONVOLUTION:
    return new LocalWeightedConvolutionLayer<Dtype>(param);
  case LayerParameter_LayerType_LOCAL_WEIGHTED_DECONVOLUTION:
    return new LocalWeightedDeconvolutionLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_ROI_POOLING:
    return new ROIPoolingLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_SIGMOID_BERNOULLI:
   return new SigmoidBernoulliLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_TENSOR_PRODUCT:
    return new TensorProductLayer<Dtype>(param);
